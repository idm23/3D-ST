...
class LFA(nn.Module):
    ...
    def forward(self, input_features: torch.Tensor, geom_features: torch.Tensor, closest_indices: torch.Tensor):
...
class StudentTeacher(nn.Module):
    def __init__(self, k, d, num_residuals):
    ...
    def forward(self, points, geom_features, closest_indices):
        # Points: N, 3
    ...
    def point_based_forward(self, points):
